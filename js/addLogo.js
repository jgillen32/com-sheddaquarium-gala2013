...
createlogo = function(){
	  ...
	  canvasWidth = document.getElementById('galaTitle').offsetWidth;
		var ctx = canvas.getContext("2d");
	  openAperture = setInterval(function(){updateIris(ctx,canvasWidth)},60);
...
function stingray(ctx) {
	...
	function drawRay(ctx,canvasWidth) {
	//var theNewCanvasWidth = window.innerWidth * .9;
	var canvasWidth = document.getElementById('galaTitle').offsetWidth;;
	canvas.width = canvasWidth
	canvas.height = canvasWidth
		
	// calculate scale.
	var newScale = canvasWidth / 270;
...
setInterval(function(){drawRay(ctx,canvasWidth)},60);
}
...
function updateIris(ctx,canvasWidth) {	
	//var theNewCanvasWidth = window.innerWidth * .9;
	canvas.width = canvasWidth;
	canvas.height = canvasWidth;
	ctx.save();
